...
\bodytext{Programming Languages \sbull Programming Environments \sbull Human-Computer Interaction \sbull CSEd}
...
\roottitle{Publications \hspace{0.1cm} \faSend}
  ...
  \headedsubsection
    ...
    {\textbf{Andrew Blinn, David Moon, Eric Griffis, Cyrus Omar} \\
     ...
     See also the \href{http://andrewblinn.com/papers/DRAFT-2022.10.andrew-blinn-prelim.pdf}{extended Paperclip Calculus edition} which formalizes suggestion sensibility}
    ...
    Type systems typically treat ill-typed expressions as meaningless, but effective editors must provide semantic services even downstream of errors. Our marked lambda calculus addresses this via a comprehensive formal account of total error localization and recovery}
...
\roottitle{Education \hspace{0.1cm} \faGraduationCap}
  ...
  \headedsubsection
    ...
    {Current}
    {Building intelligent, multi-modal programming interfaces combining LLMs,\\responsive design, and type-directed formal methods at Cyrus Omar's \href{http://fplab.mplse.org/}{FP Lab}}
